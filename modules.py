...
class UNet_conditional(nn.Module): # TODO try adding dropout
    def __init__(self, c_in=1, c_out=1, time_dim=256, device="cuda", img_width=256, img_height=128, feat_num=5):
        ...
        self.sa3 = SelfAttention(384, img_height//8, img_width//8)
        self.down4 = Down(384, 384)
        self.sa4 = SelfAttention(384, img_height//16, img_width//16)
        ...
        self.up1 = Up(768, 256)
        self.sa5 = SelfAttention(256, img_height//8, img_width//8)
        self.up2 = Up(512, 128)
        self.sa6 = SelfAttention(128, img_height//4, img_width//4)
        self.up3 = Up(256, 64)
        self.sa7 = SelfAttention(64, img_height//2, img_width//2)
        self.up4 = Up(128, 64)
        self.sa8 = SelfAttention(64, img_height, img_width)
